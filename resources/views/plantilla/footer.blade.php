...
<script src="{{asset('assets/vendors/general/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js')}}"
	type="text/javascript"></script>
<script src="{{asset('assets/vendors/general/bootstrap-maxlength/src/bootstrap-maxlength.js')}}" type="text/javascript">
</script>
<script
...
<script src="{{asset('assets/vendors/general/bootstrap-switch/dist/js/bootstrap-switch.js')}}" type="text/javascript">
</script>
...
<!--begin::Page Scripts(used by this page) -->
<script src="{{ asset('assets/js/demo1/pages/crud/forms/widgets/bootstrap-select.js') }}" type="text/javascript">
</script>

{{-- <script src="{{ asset('assets/js/demo1/pages/crud/forms/widgets/bootstrap-datepicker.js')}}"
type="text/javascript"></script> --}}
<script src="{{asset('assets/vendors/general/bootstrap-datepicker/js/locales/bootstrap-datepicker.es.js')}}"
	type="text/javascript"></script>
<script>
...
rrows = {
	...
	$('#kt_datepicker_3,#kt_datepicker_33,#kt_datepicker_333, #kt_datepicker_3_validate,.camposFecha').datepicker({
			rtl: KTUtil.isRTL(),
			clearBtn: true,
			todayHighlight: true,
			templates: arrows,
			...
			// minimum setup
	$('#kt_timepicker_2, #kt_timepicker_2_modal,.camposHora').timepicker({
			minuteStep: 1,
			showSeconds: false,
			showMeridian: true
	});    
