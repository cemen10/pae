  ...
  <div class="kt-portlet__head">
    <div class="kt-portlet__head-label">
      <h3 class="kt-portlet__head-title">
        <span class="kt-widget20__number kt-font-danger">Nuevo Producto </span>
      </h3>
    </div>
  </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-4">
                ...
                <a href="{{ url('/productos/nuevo') }}" class="btn btn-warning btn-sm"><i
                    class="fa fa-window-close"></i> Cancelar</a>&nbsp;
                <a href="{{ url('/productos') }}" class="btn btn-danger btn-sm"><i
